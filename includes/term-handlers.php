...
if (!function_exists('ef5_term_meta_export')) {
    function ef5_term_meta_export($file)
    {
        global $wp_filesystem;
        $post_types = apply_filters('ef5_post_types', array());
...
if (!function_exists('ef5_term_meta_import')) {
    function ef5_term_meta_import($file)
    {
        // File exists?
        if (file_exists($file)) {
