...
if (class_exists('WP_Importer')) {
	class EF5_Import extends WP_Importer
	{
			...
			foreach ($this->posts as $post) {
				...
				if ($post_exists && get_post_type($post_exists) == $post['post_type']) {
					...
					$postdata = array(
						...
						'post_date_gmt'  => $post['post_date_gmt'], 'post_content' => ef5_ie_replace_content($post['post_content'], $attachment),
