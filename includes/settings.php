 ...
 * @param $file
 */
function ef5_ie_setting_export($file)
{
    global $wp_filesystem;

    $option_name = ef5_ie_setting_get_opt_name($file);
...
function ef5_ie_setting_import($file)
{
    // File exists?
    if (file_exists($file)) {
        ...
        $data = ef5_ie_replace_theme_options($data);
...
function ef5_ie_setting_get_opt_name($file)
{
    ...
    $opt_name = apply_filters('ef5_ie_options_name', 'cms_theme_options');
...
function ef5_ie_replace_theme_options($options)
{

    $_replaces = apply_filters('ef5_ie_replace_theme_options', array());
