...
if (!class_exists('EF5_Import_Export')) {
    ...
    class EF5_Import_Export
    {
        ...
        function ef5_ie_menu_handle()
        {
            ...
            add_submenu_page('admin.php', esc_html__('Import Demo', EF5_IE_TEXT_DOMAIN), esc_html__('Import Demo', EF5_IE_TEXT_DOMAIN), 'manage_options', 'ef5-import', array($this, 'ef5_import_demo_page'));
        }
